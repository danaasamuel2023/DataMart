...
const MTNBundleCards = () => {
 ...
 const bundles = [
    { capacity: '1', mb: '1000', price: '4.70', network: 'mtn' },     // 4.50 + 0.20
    { capacity: '2', mb: '2000', price: '9.40', network: 'mtn' },     // 9.20 + 0.20
    { capacity: '3', mb: '3000', price: '13.70', network: 'mtn' },    // 13.50 + 0.20
    { capacity: '4', mb: '4000', price: '18.70', network: 'mtn' },    // 18.50 + 0.20
    { capacity: '5', mb: '5000', price: '23.70', network: 'mtn' },    // 23.50 + 0.20
    { capacity: '6', mb: '6000', price: '27.20', network: 'mtn' },    // 27.00 + 0.20
    { capacity: '8', mb: '8000', price: '35.70', network: 'mtn' },    // 35.50 + 0.20
    { capacity: '10', mb: '10000', price: '43.70', network: 'mtn' },  // 43.50 + 0.20
    { capacity: '15', mb: '15000', price: '62.70', network: 'mtn' },  // 62.50 + 0.20
    { capacity: '20', mb: '20000', price: '83.20', network: 'mtn' },  // 83.00 + 0.20
    { capacity: '25', mb: '25000', price: '105.20', network: 'mtn' }, // 105.00 + 0.20
    { capacity: '30', mb: '30000', price: '129.20', network: 'mtn' }, // 129.00 + 0.20
    { capacity: '40', mb: '40000', price: '166.20', network: 'mtn' }, // 166.00 + 0.20
    { capacity: '50', mb: '50000', price: '207.20', network: 'mtn' }, // 207.00 + 0.20
    { capacity: '100', mb: '100000', price: '407.20', network: 'mtn' } // 407.00 + 0.20
];
  ...
  const processPurchase = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://datamartbackened.onrender.com/api/foster/purchase-data', {
        userId: userData.id,
  ...
  return (
    <div className={`${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-black'} min-h-screen transition-colors duration-200`}>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className={`mb-6 p-4 ${isDarkMode ? 'bg-purple-900 border-purple-600' : 'bg-purple-100 border-purple-600'} border-2 rounded-lg shadow-lg`}>
          <div className="flex items-start">
            <div className="flex-shrink-0 mr-3">
              <svg className={`h-6 w-6 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
            </div>
            <div className="flex-1">
              <h3 className={`text-lg font-bold ${isDarkMode ? 'text-purple-300' : 'text-purple-800'} mb-2`}>
                ⚠️ STRICT POLICY: NO SOCIAL MEDIA ADVERTISING
              </h3>
              <p className={`text-base font-semibold ${isDarkMode ? 'text-purple-200' : 'text-purple-700'}`}>
                We do NOT allow social media advertisements of our services. If we find this page or our services advertised on your social media accounts, your account will be PERMANENTLY DELETED from our system without warning.
              </p>
              <p className={`mt-2 text-sm ${isDarkMode ? 'text-purple-300' : 'text-purple-600'}`}>
                This policy is strictly enforced to maintain service quality and prevent abuse. No exceptions will be made.
              </p>
            </div>
          </div>
        </div>
